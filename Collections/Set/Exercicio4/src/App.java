...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Set<LinguagemFavorita> minhLinguagemFavoritas2 = new TreeSet<>(minhasLinguagensFavoritas);
        for (LinguagemFavorita linguagem : minhLinguagemFavoritas2) System.out.println(linguagem);
        ...
        System.out.println("Ordem nome, ano criação e IDE");
